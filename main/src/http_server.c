...
static httpd_handle_t http_server_configure(void)
{
	...
	if (httpd_start(&http_server_handle, &config) == ESP_OK)
	{
	    ...
	    httpd_register_uri_handler(http_server_handle, &led_end_point_config);
	    ...
	    httpd_register_uri_handler(http_server_handle, &straight_end_point_config);
	       ...
	       httpd_register_uri_handler(http_server_handle, &back_end_point_config);
	       ...
	       httpd_register_uri_handler(http_server_handle, &left_end_point_config);
	       ...
	       httpd_register_uri_handler(http_server_handle, &right_end_point_config);
	       ...
	       httpd_register_uri_handler(http_server_handle, &stop_end_point_config);
	       httpd_uri_t uri_get = {
	           .uri = "/stream.jpg",
	           .method = HTTP_GET,
